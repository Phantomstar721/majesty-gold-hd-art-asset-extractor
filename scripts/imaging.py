...
_GLYPHS = {
    ...
    ",": (0x00, 0x80, 0x60, 0x00, 0x00), ";": (0x00, 0x80, 0x68, 0x00, 0x00),
    "'": (0x00, 0x07, 0x00, 0x00, 0x00), '"': (0x00, 0x07, 0x00, 0x07, 0x00),
    "?": (0x02, 0x01, 0x51, 0x09, 0x06), "%": (0x23, 0x13, 0x08, 0x64, 0x62),
    "+": (0x08, 0x08, 0x3E, 0x08, 0x08), "=": (0x14, 0x14, 0x14, 0x14, 0x14),
    "*": (0x2A, 0x1C, 0x7F, 0x1C, 0x2A), "&": (0x36, 0x49, 0x55, 0x22, 0x50),
    "[": (0x00, 0x7F, 0x41, 0x41, 0x00), "]": (0x00, 0x41, 0x41, 0x7F, 0x00),
    "<": (0x08, 0x14, 0x22, 0x41, 0x00), ">": (0x00, 0x41, 0x22, 0x14, 0x08),
    "\\": (0x02, 0x04, 0x08, 0x10, 0x20), "|": (0x00, 0x00, 0x7F, 0x00, 0x00),
    "@": (0x3E, 0x41, 0x5D, 0x55, 0x1E), "$": (0x24, 0x2A, 0x7F, 0x2A, 0x12),
    "~": (0x08, 0x04, 0x08, 0x10, 0x08), "^": (0x04, 0x02, 0x01, 0x02, 0x04),
